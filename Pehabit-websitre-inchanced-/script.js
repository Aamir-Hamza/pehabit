...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Keep navigation visible on scroll (disable hide-on-scroll)
    const navOrHeader = document.querySelector('header') || document.querySelector('nav.main-nav');
    if (navOrHeader) {
        navOrHeader.style.transform = 'translateY(0)';
        window.addEventListener('scroll', function() {
            navOrHeader.style.transform = 'translateY(0)';
        });
    }
